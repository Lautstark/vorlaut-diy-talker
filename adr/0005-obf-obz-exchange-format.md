...
- Thirteen conformance fixtures ship with the specification and are **normative
...
cannot be misread. Thirteen archives with thirteen expected results settle in bytes
