...
def check_every_module_is_reachable() -> int:
    ...
    for path in scripts():
        ...
        # "./dom.js" in static/backend/thing.js is static/backend/dom.js, and
        # in a flat reading it would have been the top-level dom.js - which
        # exists, and is a different file. That is the failure to avoid.
